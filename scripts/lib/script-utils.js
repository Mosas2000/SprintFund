...
export function getExplorerUrl(networkName, txId) {
...
export async function confirmMainnetTransaction(details) {
...
export function logDryRun(details) {
  console.log('\n========================================');
...
export function printUsage(scriptName, additionalOptions = '') {
