;; SprintFund Core v5-ultra
;; Ultra-minimal version to avoid VM bugs
;; Configurable micro-stake with proven patterns only
...
;; Helper function for STX transfer to avoid as-contract complexity
...
(define-public (execute-proposal (proposal-id uint))
  (let
    ...
    (asserts! (is-eq tx-sender payout-recipient) ERR-NOT-AUTHORIZED)
    (asserts! (not (get executed proposal)) ERR-ALREADY-EXECUTED)
