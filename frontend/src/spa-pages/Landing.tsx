...
export function LandingPage() {
  ...
  return (
    <div className="flex flex-col">
      ...
      {/* ── Features ─────────────────────────── */}
      <section aria-labelledby="features-heading" className="border-t border-border py-10 sm:py-16">
        <div className="mx-auto max-w-5xl px-4 sm:px-6">
          <h2 id="features-heading" className="mb-6 sm:mb-10 text-center text-xl sm:text-2xl font-bold text-text">How It Works</h2>
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-5 lg:grid-cols-4">
            {FEATURES.map((f) => (
              <div key={f.title} className="rounded-xl border border-border bg-card p-4 sm:p-5 text-center transition-colors hover:border-green/20">
      ...
      {/* ── Steps ────────────────────────────── */}
      <section aria-labelledby="steps-heading" className="border-t border-border py-10 sm:py-16">
        <div className="mx-auto max-w-5xl px-4 sm:px-6">
          <h2 id="steps-heading" className="mb-6 sm:mb-10 text-center text-xl sm:text-2xl font-bold text-text">Get Started</h2>
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-5 lg:grid-cols-4">
            {STEPS.map((s) => (
              <div key={s.num} className="rounded-xl border border-border bg-card p-4 sm:p-5 transition-colors hover:border-green/20">
